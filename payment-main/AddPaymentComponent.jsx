...
class AddPaymentComponent extends Component {
   ...
   /* changeamountHandler= (event) => {
    ...
    onSubmit(e) {
        e.preventDefault();
        let payment = {paymentId: this.state.paymentId,  status: this.state.status, type: this.state.type, cardName : this.state.cardName, cardNumber: this.state.cardNumber, cardExpiry : this.state.cardExpiry, cvv :this.state.cvv};
                                ...
                                <div className = "card-body">
                                    <form onSubmit={this.onSubmit} className='add-payment-form' >
                                       ...
                                       {/*<div className = "form-group">
                                        ...
                                        <div className = "form-group">
                                            <label> type: </label>
                                            <input placeholder="type" required className="form-control" 
