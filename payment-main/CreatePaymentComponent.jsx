...
class CreatePaymentComponent extends Component {
    ...
    saveOrUpdatePayment = (e) => {
        e.preventDefault();
        //alert("hi");
        let payment = { paymentId: this.state.paymentId, brand: this.state.brand,  type: this.state.type, registrationState: this.state.registrationState, registrationYear: this.state.registrationYear, variant: this.state.variant };
   ...
   /* changepaymentAmountHandler = (event) => {
    ...
    onSubmit(e) {
        ...
        if (!this.state.brand || !this.state.type1 || !this.state.registrationState || !this.state.registrationYear || !this.state.variant) {
                                ...
                                <form onSubmit={this.onSubmit} className='add-payment-form' >
                                   ...
                                   {/* <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input placeholder="Payment Type" required className="form-control"
                                            value={this.state.type} onChange={this.changepaymentTypeHandler} />
                                    </div>
